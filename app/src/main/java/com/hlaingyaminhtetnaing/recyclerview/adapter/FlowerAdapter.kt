package com.hlaingyaminhtetnaing.recyclerview.adapter

import android.view.LayoutInflater
import android.view.View
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.hlaingyaminhtetnaing.recyclerview.R
...
class FlowerAdapter(var flowerList:ArrayList<Flower>):
    ...
    class FlowerViewHolder(itemView: View):RecyclerView.ViewHolder(itemView)//conect item layout
    {
